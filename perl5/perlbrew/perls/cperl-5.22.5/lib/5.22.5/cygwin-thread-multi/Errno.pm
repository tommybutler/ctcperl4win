...
"cygwin-thread-multi-2.8.2(0.31353)" or
	die "Errno architecture (cygwin-thread-multi-2.8.2(0.31353)) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
